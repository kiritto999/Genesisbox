...
public void update(double deltaTime) {
    ...
    public void saveToDatabase() {
        ...
        EntitySV eSV= new EntitySV();

        eSV.clearAll(); // evita duplicados

        for (Entity e : entities) {

            int id = eSV.insertEntity(
            ...
            if (e instanceof Animal a) {
                eSV.insertAnimal(id, a.getHealth(), a.getCapacity());
            }

            if (e instanceof Resource r) {
                eSV.insertResource(id, r.getClass().getSimpleName());
            }
        }
    }
        ...
        try (Statement stmt = conn.createStatement();
            ...
            while (rs.next()) {
                ...
                // 🐾 ANIMALES (AJUSTA A LOS TUYOS)
                    ...
                    // opcional si tienes estos atributos en BD
                    try {
                ...
                // 🔗 AGREGAR CORRECTAMENTE (SIN DUPLICAR)
                if (e != null) {
